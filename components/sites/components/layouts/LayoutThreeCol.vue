  ...
  v-row(style="min-height:200px")
    v-col(cols="12" md="4")
      ...
      div.rounded.d-flex.align-center.addNew(v-else)
        sites-builder-add-block(:position="0" @addBlock="addBlock" :blockList="Blocks")
    v-col(cols="12" md="4")
      component(v-if="components[1]"  :is="components[1].component" :data="components[1]")
      div.rounded.d-flex.align-center.addNew(v-else)
        sites-builder-add-block(:position="1" @addBlock="addBlock" :blockList="Blocks")
    v-col(cols="12" md="4")
      component(v-if="components[2]"  :is="components[2].component" :data="components[2]")
      div.rounded.d-flex.align-center.addNew(v-else)
        sites-builder-add-block(:position="2" @addBlock="addBlock" :blockList="Blocks")
