<template lang="pug">
h3.mx-auto(:id="data._uid" title="heading" style="text-align:center; max-width:31rem; text-wrap:balance;" :style="{fontFamily:css?.font.family, fontSize:css?.font.size}" :contenteditable="editable") {{ content }}
</template>
